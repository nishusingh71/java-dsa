...
public class RedBlackTree {
    ...
    // this functions performs left rotation
    ...
    // this functions performs right rotation
    ...
    // helper functions for insertions. Actually this function performs all tasks in
    // single pass only.
    Node insertHelp(Node root, int data) {
        // f is true when RED RED conflict ias there.
        boolean f = false;
        // recursive calls to insert at proper positions according to BST properties.
        if (root == null)
            ...
            // at the same of insertion, we are also assigning parent nodes
        ...
        // Now lets take care of RED RED Conflicts
        if (f) {
            // to check which child is the current node of its parent
            if (root.parent.right == root) {
                // case when parent's sibling to black
                if (root.parent.left == null || root.parent.left.colour == 'B') {
                    // perform certaining rotation and recolouring.This will be done while
                    // backtracking.
                ...
                // case when parent's sibling is red
                    ...
                    if (root.parent.right == null || root.parent.right.colour == 'B') {
                        if (root.left != null && root.right.colour == 'R')
                            this.rr = true;
                        else if (root.right != null && root.right.colour == 'R')
                            this.lr = true;
                    } else {
    ...
    // helper function to get print inorder traversal
    ...
    // functions to print inorder traversal
